  ...
  return (
    <Bounded as="footer" className="text-slate-600">
      <div className="container mx-auto mt-20 flex flex-col items-center justify-between gap-6 py-8 sm:flex-row ">
        ...
        {isFilled.link(settings.data.githublink) && (
            <PrismicNextLink
                field={settings.data.githublink}
          ...
          {isFilled.link(settings.data.linkedinlink) && (
            <PrismicNextLink
              field={settings.data.linkedinlink}
              className="p-2 text-2xl text-slate-300 transition-all duration-150 hover:scale-125 hover:text-yellow-400"
          ...
          {isFilled.link(settings.data.facebooklink) && (
            <PrismicNextLink
              field={settings.data.facebooklink}
              className="p-2 text-2xl text-slate-300 transition-all duration-150 hover:scale-125 hover:text-yellow-400"
